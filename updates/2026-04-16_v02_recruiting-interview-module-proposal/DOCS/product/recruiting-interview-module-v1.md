...
This document defines the first formal product and governance boundary for the Lemma Recruiting MVP.
...
This is a public product and contract proposal. It is the documentation truth source for this slice until a runtime repo explicitly aligns to it.

## MVP Scope

Recruiting MVP is limited to the following operational slices:
...
The final decision must remain with a human reviewer.
